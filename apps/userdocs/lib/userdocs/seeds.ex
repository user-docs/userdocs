defmodule Userdocs.Seeds do
  ...
  def create_objects(repo) do
    IO.puts("Seeding")
    opts = %{broadcast: false, context: %{repo: repo}}
    ...
    team_type = case repo do
      Userdocs.Repo -> :team
      Userdocs.LocalRepo -> :personal
    end

    userdocs_team = %{
      name: "Userdocs",
      aws_bucket: "userdocs-image-repo",
    ...
    {:ok, _the_internet_project = %Project{id: the_internet_project_id}} =
      %Project{}
      |> Project.changeset(the_internet_project)
      |> repo.insert()

    {:ok, _userdocs_project = %Project{id: userdocs_project_id}} =
      %Project{}
      |> Project.changeset(userdocs_project)
      |> repo.insert()

    {:ok, _john_davenport_rocks_project = %Project{id: _john_davenport_rocks_project_id}} =
      %Project{}
