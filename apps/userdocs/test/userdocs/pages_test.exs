defmodule Userdocs.WebTest do
  ...
  describe "pages" do
    ...
    @valid_attrs %{name: "some name", order: 42, url: "some url"}
    @update_attrs %{name: "some updated name", order: 43, url: "some updated url"}
    @invalid_attrs %{name: nil, order: nil, url: nil}
