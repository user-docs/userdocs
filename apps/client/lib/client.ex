defmodule Client do
  ...
  def get_project!(id), do: GenServer.call(__MODULE__.Server, {:get_project!, id, []}, @timeout)
  ...
  def get_screenshot!(id), do: GenServer.call(__MODULE__.Server, {:get_screenshot!, id, []}, @timeout)
  ...
  def get_process!(id), do: GenServer.call(__MODULE__.Server, {:get_process!, id, []}, @timeout)
  ...
  def delete_process(id, opts \\ %{}), do: GenServer.call(__MODULE__.Server, {:delete_process, id, opts}, @timeout)
