defmodule Client do
  ...
  alias Userdocs.SubscriptionData
  ...
  def handle_info(%Message{event: event, payload: %{"attrs" => attrs, "type" => type}},
    ...
    SubscriptionData.apply(attrs, type, event)
    object = SubscriptionData.cast(attrs, type)
    {:noreply, Userdocs.Subscription.handle_event(state, event, object, state_opts)}
  end
